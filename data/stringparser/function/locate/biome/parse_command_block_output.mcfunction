...
execute if data storage stringparser:data {locate:{successful:"translate"}} run function stringparser:locate/biome/success
execute unless data storage stringparser:data {locate:{successful:"translate"}} run function stringparser:locate/biome/failure